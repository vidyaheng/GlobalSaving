...
function initDiscountHelpPopup() {
  const wrapper = document.getElementById("discount-help");
  const trigger = document.getElementById("discount-help-trigger");
  const popup = document.getElementById("discount-help-popup");

  if (!wrapper || !trigger || !popup) return;
  ...
  wrapper.addEventListener("mouseleave", closePopup);
...
document.addEventListener("DOMContentLoaded", initDiscountHelpPopup);
